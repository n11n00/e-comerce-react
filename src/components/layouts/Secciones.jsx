...
const Secciones = () => {
    ...
    return (
        ...
        <li className="nav-item">
            ...
            <Link className="nav-link active" to="/carrito"><button type="button" className='btn btn-primary'><img src="https://firebasestorage.googleapis.com/v0/b/react-34755-2022-b9d9f.appspot.com/o/Imagenes%2Fcarrito.png?alt=media&token=acd7e4c9-052e-4570-b1bc-05e08e5d4ef3" alt="" /><span className="badge text-bg-secondary">{carrito.length}</span></button></Link>
                    </li>
        </>
    );
}
